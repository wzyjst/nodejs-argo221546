...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'kj.jxjjdcx.de5.net';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYTQxZGE1YzExOGIxNzlmZDk1MTc4MDQ1Y2U4MWQ1MDkiLCJ0IjoiZTYxNDE5MjEtNzFiMi00MGNhLWFhOGMtMGVkNzAyODQwZTRhIiwicyI6Ik1EYzRZelpqT0RZdFl6azFNeTAwWmpjM0xXRmtPVFl0WWpVM016UXhORGRsWVRJeiJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
const ARGO_PORT = process.env.ARGO_PORT || 8001;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
const CFIP = process.env.CFIP || 'cdns.doon.eu.org';        // 节点优选域名或优选ip  
const CFPORT = process.env.CFPORT || 443;                   // 节点优选域名或优选ip对应的端口
const NAME = process.env.NAME || 'kj';                        // 节点名称
